        ...
        <div className="md:w-1/2 w-full">
          <div>
            ...
            <div className="flex md:flex-row flex-col md:items-center md:justify-between mb-5">
              <button type="submit" className="p-2 px-4 bg-blue-500 text-center text-white rounded-md block md:w-24 md:mb-0 mb-5 w-full ">Login</button>
              <button type="submit" className="p-2 border-2 border-gray-800/35 text-center text-black rounded-md block md:w-24 w-full ">Reginster</button>
            </div>
