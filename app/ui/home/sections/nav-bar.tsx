    ...
    <nav className="py-1.5 px-4 fixed top-0 left-0 right-0 z-10 bg-white w-full shadow-md">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <input className="md:block outline-none border-none bg-gray-100 hidden py-2 px-4 rounded-3xl border-2 border-gray-300" placeholder="Search Developers ..."></input>
