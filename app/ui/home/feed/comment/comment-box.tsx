                ...
                return (
                  ...
                  <div className="flex flex-row mb-3 space-x-3 pb-2" key={i}>
                    <div className="relative group flex-none">
                      ...
                      <div className={`absolute group-hover:block hidden w-96 z-50  -left-32 rounded-lg  p-4  bg-white shadow-lg`}>
...
const dummyComments = [
  ...
  {
    comment: 'Up is opinion message manners correct hearing husband my. Disposing commanded dashwoods cordially depending at at. Its strangers who you certainty earnestly resources suffering she. Be an as cordially at resolving furniture preserved believing extremity. Easy mr pain felt in. Too northward affection additions nay. He no an nature ye talent houses wisdom vanity denied.',
    time: '2h'
  },
  {
    comment: 'Do commanded an shameless we disposing do.',
  ...
  {
    comment: 'Extremity excellent certainty discourse sincerity no he so resembled. Joy house worse arise total boy but. Elderly up chicken do at feeling is. Like seen .',
    time: '2m'
  },
  {
    comment: 'Written enquire .',
